...
if (!isset($_GET['the_stream']) || !isset($_GET['cur_i'])) {
		...
		if (strpos($the_link,'radionomy.com')) { //is a radionomy.com link
			...
			$streamtitle=$matches[2];
					...
					if (!$fp) {
						$streamtitle = "Connection timed out"; // If you always get this error then it means your web host is blocking outward connections. If you ask nicely, they might add your server IP to their allow list.
						//$is_shoutcast=false;
					} else {
